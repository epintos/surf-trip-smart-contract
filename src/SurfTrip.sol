...
contract SurfTrip is Ownable, ReentrancyGuard {
    ...
    mapping(address surfer => uint256 balance) private s_surfersBalances;
    ...
    function refund(uint256 amount) external moreThanZero(amount) beforeDeadline nonReentrant {
